document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ...
    ar: {
      ...
      "privacy-s1-desc": "تم تصميم ليبريكسا ليكون منظماً ومشغلاً محلياً ومستقلاً لمكتبتك الصوتية. نحن نؤمن بأن سجل استماعك وملفاتك الصوتية وعادات قراءتك ملك لك وحدك. يعمل ليبريكسا بدون تسجيل حسابات أو الحاجة لخوادم سحابية إجبارية.",
      "privacy-s2-title": "2. المزامنة والوصول إلى Google Drive",
      "privacy-s2-desc": "عند اختيار ربط حسابك على جوجل درايف داخل ليبريكسا:",
      "privacy-s2-l1": "<strong>صلاحية قراءة فقط:</strong> يطلب ليبريكسا صلاحيات قراءة محدودة حصرياً للمجلدات والكتب الصوتية التي تختارها أنت للبث أو التحميل.",
      "privacy-s2-l2": "<strong>بدون خوادم وسطية:</strong> لا يقوم ليبريكسا برفع أو نسخ أو نقل أي من ملفاتك إلى أي خوادم خارجية أو خوادم تحليلية.",
      "privacy-s2-l3": "<strong>تفويض مباشر وآمن:</strong> تتم عملية تسجيل الدخول مباشرة بين جهازك وخوادم تفويض جوجل (OAuth 2.0). لا يطلع ليبريكسا إطلاقاً على كلمة سر حسابك.",
      "privacy-s3-title": "3. جمع البيانات والتخزين المحلي",
      "privacy-s3-desc": "لا يجمع ليبريكسا أي بيانات شخصية باستثناء ما هو مطلوب لتشغيل وظائف التطبيق محلياً على جهازك:",
      "privacy-s3-l1": "<strong>سجل الاستماع والإشارات المرجعية:</strong> يتم حفظ تقدمك في الاستماع، العلامات المرجعية، إعدادات مؤقت النوم، والإحصائيات بنسبة 100% محلياً على ذاكرة جهازك.",
      "privacy-s3-l2": "<strong>بدون تحليلات أو تتبع:</strong> لا يحتوي ليبريكسا على أي أدوات تتبع إعلانية أو برمجيات تحليل سلوك. نحن لا نتتبع ما تستمع إليه أو متى تستمع.",
      "privacy-s3-l3": "<strong>حرية ونقل البيانات:</strong> يمكنك تصدير سجل استماعك وإعداداتك كملف إعدادات محلي (.lxb) بنقرة واحدة لاستعادته أو نقله لأي جهاز آخر.",
      "privacy-s4-title": "4. الخدمات الخارجية والطرف الثالث",
      "privacy-s4-desc": "لا يشارك ليبريكسا أو يبيع أي بيانات للمستخدمين. الاتصال الخارجي الوحيد الذي يتم يكون مباشرة بين جهازك وخدمات Google APIs عند استخدامك ميزة المزامنة السحابية.",
      "privacy-s5-title": "5. التواصل وتطوير التطبيق",
      "privacy-s5-desc": "إذا كان لديك أي أسئلة أو استفسارات حول الخصوصية في ليبريكسا، يسعدنا تواصلك من خلال القنوات الرسمية:",
